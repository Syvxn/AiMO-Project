  ...
  return (
    <section className="space-y-6">
      ...
      <div className="card space-y-3">
        ...
        <p className="text-slate-300">Coming next: embedded game canvas and player session handoff.</p>
        <button className="btn-primary" type="button">Launch Game (Stub)</button>
      </div>
    </section>
  );
}
